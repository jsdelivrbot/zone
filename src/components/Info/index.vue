<template>
	<div id="headed" style="overflow-y:scroll;font-size: 0.2rem;width: 100%;">
		<my-header title="资讯" uri="#/home"></my-header>
...
//	},
	...
	created(){
		...
		//获取资源分类
		this.$http.get(getOpenUrl() + "newscates", {
			headers: {
				'Authorization':'Bearer ' +  token
			},
		}).then((res)=>{
...
.tip-bottom-r .li3{color: #afafaf;line-height: 0.25rem;height: 0.25rem;font-size: 0.2rem;/*margin-left: 0.15rem;*/margin-top: 0.15rem;padding: 0 0.15rem;padding-left: 0;}
