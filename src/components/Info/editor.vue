	...
	<div class="comment">
		...
		<div class="ftall">
          ...
          <input style="opacity:0;position: absolute;width:0.34rem;height:0.64rem;" type="file" id="imgView" accept="image/*" @change="onchange">
				...
				<li class="li4" @click="submit" v-if="isUpload" style="border-radius:0.2rem;">
					<input type="button" value="确定" style="color: #fff;font-size: 0.2rem"/>
				</li>
        <li class="li4" v-else>
          <input type="button" value="正在上传.." style="color: #fff;font-size: 0.2rem"/>
        </li>
			</ul>
		</div>
...
<style scoped>
.header{position: fixed;top: 0;height: 0.7rem;box-shadow:0 0 5px #ebebeb;width: 100%;background: #fff;z-index: 999;padding-top: 0.3rem;}
