<template>
  <div id="headed" style="overflow-y:auto;">
    <my-header title="我的答疑"></my-header>
    ...
    <div class="page-loadmore" style="padding-top:1.7rem;overflow:auto;font-size: 0.2rem;height: calc(100% - 1.7rem);">
...
//
    ...
    methods: {
      loadTop() { // 刷新数据的操作
        ...
        this.$http.get(getOpenUrl() + "workorderIndex", {
          headers: {
      ...
      getData(type, page, size) {
        ...
        switch(this.type) {
          ...
          case 3:
            //已完成
            if(start <= this.sDone && this.itemsDone.length > 0) {
              start = this.sDone;
              this.isload = false;
              $('.load').hide();
              end = this.eDone;
