    ...
    <div class="nav">
      <form>
        ...
        <div style="position: relative;">
          <img src="../../images/login_loading.gif" style="position: absolute;width: 0.5rem;height: 0.5rem;top: 50%;transform: translateY(50%);left: 1.65rem;" alt="" v-show="loadinging">
          <input type="button" value="确认" class="btn input mt5" v-bind:class="{isDj:is_dianji}" @click="resetpass()">
        </div>
      </form>
    </div>
