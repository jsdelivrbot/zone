<template>
  <div class="tjshdz">
    ...
    <div class="body">
    	<div class="bodyall">
    		<div class="body-top">
    			<input type="text"  placeholder="请输入原绑定手机号" class="txt" ref="mobile"/>
...
<style scoped>
  ...
  .body{padding-top: 1rem;padding-bottom: 0.98rem;width: 5.84rem;margin: 0 auto;}
  .bodyall{margin-top: 0.62rem;}
  .body-top{width: 5.84rem;height: 0.7rem;background: #f0f0f0;
    /*border-radius: 0.35rem;*/
    margin-bottom: 0.37rem;}
  .body-top input{display: block;float: left;}
  .body-top .txt{color: #fff;line-height: 0.7rem;padding-left: 0.31rem;font-size: 0.2rem;color: #adadad;}
  .body-top .btn{width: 1.9rem;height: 0.7rem;
    /*border-radius: 0.35rem;*/
    background: #46c2ff;color: #fff;float: right;}
</style>
